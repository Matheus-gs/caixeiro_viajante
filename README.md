O algoritmo apresentado é uma implementação básica do método de força bruta para resolver o problema do Caixeiro Viajante. Vou explicar a metodologia geral utilizada neste algoritmo:
